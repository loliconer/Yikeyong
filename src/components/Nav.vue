<template>
  <nav class="yky-nav">
    <div class="logo"><a class="link" href="/"><img src="/img/logo.png" alt="Yikeyong Logo"></a></div>
    <ul class="n-list">
      <li><a class="link" href="/">首页</a></li>
      <li><a class="link" href="https://moshui.yikeyong.com">墨水</a></li>
      ...
      <li>
        <a class="link" href="https://github.com/loliconer" target="_blank">
          <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 16 16" version="1.1" width="32">
